...
export default function ViewSingleSubmitAssignment() {
  const { id } = useParams();
  ...
  const APIURL = "http://localhost:9092/sumbitAssignment/view/prof";
  ...
  const addReply = (e, inputTask) => {
    ...
    inputTask.replies = [...inputTask.replies, data];
    axios
      .put(
              ...
              >
                ...
                <IconButton>
                  <CheckCircle
                    ...
                    onClick={() => {
                      updateScore(score, assignments?.submitId);
                    }}
                  />
                  <Loop
                    className="loop"
                    style={{
                      display: `${loopVisibility}`,
                    }}
                  />
                </IconButton>
              </Grid>
